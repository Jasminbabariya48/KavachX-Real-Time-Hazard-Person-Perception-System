...
def test_gen(extra_args):
    ...
    print(f"=== TEST: {extra_args} ===")
    print("STDOUT:\n", res.stdout)
    print("STDERR:\n", res.stderr)
    print("RETURN CODE:", res.returncode)

test_gen("--backend_binary kavachx_3class_int8_htp_v68.bin")
test_gen("--binary_file /home/work_user2/kawachx_task/results/htp_compilation/output/kavachx_3class_int8_htp_v68.bin")
